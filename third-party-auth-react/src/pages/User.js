...
function User() {
  ...
  const fetchHistory = async (id) => {
    ...
    let history = await axios.get("https://messwala.tech/history/" + id);
  ...
  const getUser = async (user) => {
    ...
    let userDate = await axios.get("https://messwala.tech/user/" + user);
  ...
  const updateUser = async () => {
    ...
    let user = await axios.put("https://messwala.tech/user/" + userId, userDate);
    if (user) {
      setAlertMessage({
